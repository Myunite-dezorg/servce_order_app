    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_number', models.CharField(default='532E662', editable=False, max_length=7, unique=True)),
                ...
                ('modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders_modified', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
